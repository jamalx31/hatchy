...
function Home(props: any) {
   ...
   const [inFocus, setInFocus] = useState<any>(1)
                     ...
                     <div className="flex-1">
                        <div className="flex relative mb-3">
                           <textarea placeholder="What's happening"
                              ...
                              className={`w-full textarea outline-none p-2 bg-transparent text-xl text-gray-400`} />
                           {
                              !t.text && !!i &&
                        ...
                        </div>
                        {
                           ...
                           <div className="flex items-center ">
                              <div className="w-6 h-6 mr-2 text-teal-300">
